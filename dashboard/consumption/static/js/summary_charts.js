 ...
 */
function show_summary_charts(total_consumptions, average_consmptions)
{
  var total_chart = new Chart($("#chart1"), get_base_chart_config());
  var average_chart = new Chart($("#chart2"), get_base_chart_config());
